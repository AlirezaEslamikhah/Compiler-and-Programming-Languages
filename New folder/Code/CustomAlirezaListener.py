...
class CustomListener(ParseTreeListener):
    ...
    def exitCompilationUnit(self, ctx: JavaParser.CompilationUnitContext):
        ...
        if self.print_option:
            ...
            print(
                f"Calculated program length = {self.n1_uniquieoperators * math.log(self.n1_uniquieoperators, 2) + self.n2_uniqueoperands * math.log(self.n2_uniqueoperands, 2)}")
            print(f"The formula for Voulume is : Volume = (N1 + N2) * log2(n1 + n2)")
            print(
                f"Volume = {(self.N1_operators + self.N2_operands) * (math.log(self.n1_uniquieoperators + self.n2_uniqueoperands, 2))}")
            ...
            print(
                f"Effort = {(self.n1_uniquieoperators / 2) * (self.N2_operands / self.n2_uniqueoperands) * ((self.N1_operators + self.N2_operands) * (math.log(self.n1_uniquieoperators + self.n2_uniqueoperands, 2)))}")
            print(f"The formula for Time is : Time = Effort / 18")
            print(
                f"Time = {(self.n1_uniquieoperators / 2) * (self.N2_operands / self.n2_uniqueoperands) * ((self.N1_operators + self.N2_operands) * (math.log(self.n1_uniquieoperators + self.n2_uniqueoperands, 2))) / 18}")
            print(f"The formula for Size is : Size = Effort / 3000")
            print(
                f"Size = {(self.n1_uniquieoperators / 2) * (self.N2_operands / self.n2_uniqueoperands) * ((self.N1_operators + self.N2_operands) * (math.log(self.n1_uniquieoperators + self.n2_uniqueoperands, 2))) / 3000}")
    ...
    def complexity_factor(self):
        ...
        print("The Second Software Quality Factor is *Complexity*")
        print(f"The Cyclomatic Complexity Metric is: {self.graphh.edges_numbers - self.graphh.last_node_numbers + 2} ")
