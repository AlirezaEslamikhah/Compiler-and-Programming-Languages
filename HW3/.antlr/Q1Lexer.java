...
public class Q1Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "IF", "WHILE", "INT", 
			"BOOL", "ID", "INTTYPE", "BOOLTYPE", "WS", "RELOP", "EQ", "COMMENT", 
			"LETTER", "DIGIT"
		};
	}
	...
	public Q1Lexer(CharStream input) {
		super(input);
