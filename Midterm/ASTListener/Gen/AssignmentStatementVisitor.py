...
class AssignmentStatementVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by AssignmentStatementParser#ternerycond.
    def visitTernerycond(self, ctx:AssignmentStatementParser.TernerycondContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by AssignmentStatementParser#ternety.
    def visitTernety(self, ctx:AssignmentStatementParser.TernetyContext):
        return self.visitChildren(ctx)
